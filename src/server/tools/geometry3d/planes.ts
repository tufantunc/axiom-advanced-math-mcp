...
function planeFromPoints(args: Record<string, unknown>) {
...
function pointPlaneDistance(args: Record<string, unknown>) {
  const lists = (args.lists as number[][]) ?? [];
...
function linePlaneIntersection(args: Record<string, unknown>) {
  const lists = (args.lists as number[][]) ?? [];
...
function planePlaneAngle(args: Record<string, unknown>) {
  const lists = (args.lists as number[][]) ?? [];
...
function lineLineDistance(args: Record<string, unknown>) {
  const lists = (args.lists as number[][]) ?? [];
