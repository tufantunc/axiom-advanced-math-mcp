...
| `AXIOM_INTEGRATION_BUDGET_MS` | `30000` | Wall-clock budget for one multi-call numerical routine (integration, root finding). Bounds the SUM of CAS calls, where `AXIOM_EVAL_TIMEOUT_MS` bounds one. |
